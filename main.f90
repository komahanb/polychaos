subroutine PCestimate(dim,ndimint,fctin,DATIN,orderfinal,nptsin,trainingdataptsin,testptin,fmeanout)

!(ndimin,ndimint,fctin,DATIN,initpts,ncyc,nptsin,statin,trainingdataptsin,testptin,fmeanout)
...
!  print*,dim,ndimint,fctin,DATIN,orderfinal,nptsin
!  print*,trainingdataptsin
!  print*,testptin
...
!!$                 end do
              ...
              dyncyccnt=0
              do DIMPC =orderfinal,orderfinal !order 5D requires 3003 terms
...
!                 npts=npts-1 !leaving one for CV ?
