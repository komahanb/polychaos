...
if (fctindx.eq.0) then
   ...
   df(3) = L*sqrt(2.0)*gamma
         ...
         df(1)=((x(2) + 2.0**(1.0/2.0)*x(3))*(x(3)*pu + x(3)*pv &
              & + 2.0**(1.0/2.0)*x(2)*pu))/(tensile_sigma1_max*(x(1)*x(2)&
              & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)

         df(2)=((x(1) + x(3))*(x(3)*pu + x(3)*pv &
              & + 2.0**(1.0/2.0)*x(2)*pu))/(tensile_sigma1_max*(x(1)*x(2) + x(2)*x(3) &
              & + 2.0**(1.0/2.0)*x(1)*x(3))**2) - (2.0**(1.0/2.0)*pu)/(tensile_sigma1_max*(x(1)*x(2) &
              & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3)))

         df(3)=((x(2) + 2.0**(1.0/2.0)*x(1))*(x(3)*pu + x(3)*pv &
              & + 2.0**(1.0/2.0)*x(2)*pu))/(tensile_sigma1_max*(x(1)*x(2)&
              & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2) &
              & - (pu + pv)/(tensile_sigma1_max*(x(1)*x(2) &
              & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3)))    


else if (fctindx.eq.2) then
  df(1)=((pu*(x(1) - x(3)) - pv*(x(1) + x(3)))*(x(2) &
       & + 2.0**(1.0/2.0)*x(3)))/(tensile_sigma2_max*(x(1)*x(2) &
       & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2) &
       & - (pu - pv)/(tensile_sigma2_max*(x(1)*x(2) &
       & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3)))

         df(2)=((x(1) + x(3))*(pu*(x(1) - x(3)) - pv*(x(1) &
              & + x(3))))/(tensile_sigma2_max*(x(1)*x(2) &
              & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)

         df(3)=(pu + pv)/(tensile_sigma2_max*(x(1)*x(2) + x(2)*x(3) &
              & + 2.0**(1.0/2.0)*x(1)*x(3))) + ((pu*(x(1) - x(3)) &
              & - pv*(x(1) + x(3)))*(x(2) + 2.0**(1.0/2.0)*x(1)))/(tensile_sigma2_max*(x(1)*x(2)&
              &  + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)


else if (fctindx.eq.3) then

     df(1)=((x(2) + 2.0**(1.0/2.0)*x(3))*(x(1)*pu - x(1)*pv &
          & + 2.0**(1.0/2.0)*x(2)*pu))/(tensile_sigma3_max*(x(1)*x(2) &
          & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2) &
          & - (pu - pv)/(tensile_sigma3_max*(x(1)*x(2) + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3)))

         df(2)=((x(1) + x(3))*(x(1)*pu - x(1)*pv &
              & + 2.0**(1.0/2.0)*x(2)*pu))/(tensile_sigma3_max*(x(1)*x(2) &
              & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2) &
              & - (2.0**(1.0/2.0)*pu)/(tensile_sigma3_max*(x(1)*x(2) &
              & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3)))

         df(3)=((x(2) + 2.0**(1.0/2.0)*x(1))*(x(1)*pu - x(1)*pv &
              & + 2.0**(1.0/2.0)*x(2)*pu))/(tensile_sigma3_max*(x(1)*x(2) &
              & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)

else if (fctindx.eq.4) then

   df(1)=-((x(2) + 2.0**(1.0/2.0)*x(3))*(x(3)*pu + x(3)*pv + 2.0**(1.0/2.0)*x(2)*pu))/(comp_sigma1_max*(x(1)*x(2) &
        & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)

         df(2)=(2.0**(1.0/2.0)*pu)/(comp_sigma1_max*(x(1)*x(2) + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))) &
              & - ((x(1) + x(3))*(x(3)*pu + x(3)*pv &
              & + 2.0**(1.0/2.0)*x(2)*pu))/(comp_sigma1_max*(x(1)*x(2) &
              & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)

         df(3)=(pu + pv)/(comp_sigma1_max*(x(1)*x(2) + x(2)*x(3) &
              & + 2.0**(1.0/2.0)*x(1)*x(3)))&
              & - ((x(2) + 2.0**(1.0/2.0)*x(1))*(x(3)*pu + x(3)*pv &
              & + 2.0**(1.0/2.0)*x(2)*pu))/(comp_sigma1_max*(x(1)*x(2) &
              & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)
         ...
         df(1)=(pu - pv)/(comp_sigma2_max*(x(1)*x(2) + x(2)*x(3) &
              & + 2.0**(1.0/2.0)*x(1)*x(3))) - ((pu*(x(1) - x(3)) - pv*(x(1) &
              & + x(3)))*(x(2) + 2.0**(1.0/2.0)*x(3)))/(comp_sigma2_max*(x(1)*x(2) &
              & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)

         df(2)=-((x(1) + x(3))*(pu*(x(1) - x(3)) &
              & - pv*(x(1) + x(3))))/(comp_sigma2_max*(x(1)*x(2) &
              & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)

         df(3)=- (pu + pv)/(comp_sigma2_max*(x(1)*x(2) + x(2)*x(3) &
              & + 2.0**(1.0/2.0)*x(1)*x(3))) - ((pu*(x(1) - x(3)) &
              & - pv*(x(1) + x(3)))*(x(2) &
              & + 2.0**(1.0/2.0)*x(1)))/(comp_sigma2_max*(x(1)*x(2)&
              & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)


else if (fctindx.eq.6) then

   df(1)=(pu - pv)/(comp_sigma3_max*(x(1)*x(2) + x(2)*x(3) &
        & + 2.0**(1.0/2.0)*x(1)*x(3))) - ((x(2) + 2.0**(1.0/2.0)*x(3))*(x(1)*pu &
        & - x(1)*pv + 2.0**(1.0/2.0)*x(2)*pu))/(comp_sigma3_max*(x(1)*x(2) &
        & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)

         df(2)=(2.0**(1.0/2.0)*pu)/(comp_sigma3_max*(x(1)*x(2) + x(2)*x(3) &
              & + 2.0**(1.0/2.0)*x(1)*x(3))) - ((x(1) + x(3))*(x(1)*pu - x(1)*pv&
              & + 2.0**(1.0/2.0)*x(2)*pu))/(comp_sigma3_max*(x(1)*x(2) &
              & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)
         ...
         df(1) = ((1.0/max_u_disp)*L*(x(2) + 2.0**(1.0/2.0)*x(3))*(x(1)*pu &
              & + x(3)*pu - x(1)*pv + x(3)*pv &
              & + 2.0*2.0**(1.0/2.0)*x(2)*pu))/(E*(x(1)*x(2) &
              & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2) &
              & - ((1.0/max_u_disp)*L*(pu - pv))/(E*(x(1)*x(2) &
              & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3)))

         df(2) = ((1.0/max_u_disp)*L*(x(1) + x(3))*(x(1)*pu &
              & + x(3)*pu - x(1)*pv + x(3)*pv + 2.0*2.0**(1.0/2.0)*x(2)*pu))/(E*(x(1)*x(2) &
              & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2) &
              & - (400.0*2.0**(1.0/2.0)*L*pu)/(E*(x(1)*x(2) &
              & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3)))

         df(3) = ((1.0/max_u_disp)*L*(x(2) + 2.0**(1.0/2.0)*x(1))*(x(1)*pu &
              & + x(3)*pu - x(1)*pv + x(3)*pv + 2.0*2.0**(1.0/2.0)*x(2)*pu))/(E*(x(1)*x(2) &
              & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2) &
              & - ((1.0/max_u_disp)*L*(pu + pv))/(E*(x(1)*x(2) &
              & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3)))
   ...
   df(1)= -((1.0/max_v_disp)*L*(pu - pv))/(E*(x(1)*x(2) + x(2)*x(3) &
        & + 2.0**(1.0/2.0)*x(1)*x(3))) - ((1.0/max_v_disp)*L*(x(2) &
        & + 2.0**(1.0/2.0)*x(3))*(x(3)*pu - x(1)*pu + x(1)*pv &
        & + x(3)*pv))/(E*(x(1)*x(2) + x(2)*x(3) &
        & + 2.0**(1.0/2.0)*x(1)*x(3))**2)

         df(2)= -((1.0/max_v_disp)*L*(x(1) + x(3))*(x(3)*pu - x(1)*pu &
              & + x(1)*pv + x(3)*pv))/(E*(x(1)*x(2) + x(2)*x(3) &
              & + 2.0**(1.0/2.0)*x(1)*x(3))**2)

         df(3)= ((1.0/max_v_disp)*L*(pu + pv))/(E*(x(1)*x(2) &
              & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))) &
              & - ((1.0/max_v_disp)*L*(x(2) + 2.0**(1.0/2.0)*x(1))*(x(3)*pu &
...
!!$     dat(6)=Fs
     ...
     if (fctindx.eq.0) then
        ...
        d2f(1,1)= -(2.0*(x(2) + 2.0**(1.0/2.0)*x(3))**2.0*(pu*x(3) &
             & + pv*x(3) + 2.0**(1.0/2.0)*pu*x(2)))/(tensile_sigma1_max*(x(1)*x(2) &
        ...
        d2f(3,3)=-((2.0*(x(2) + 2.0**(1.0/2.0)*x(1))**2.0*(pu*x(3) &
             ...
             & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**3 &
             & - (2.0*(x(2) + 2.0**(1.0/2.0)*x(1))*(pu + pv))/(x(1)*x(2) &
             & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)/tensile_sigma1_max


        d2f(2,1)=((pu*x(3) + pv*x(3) + 2.0**(1.0/2.0)*pu*x(2))/(x(1)*x(2) &
             & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2 &
             & + (2.0**(1.0/2.0)*pu*(x(2) &
             & + 2.0**(1.0/2.0)*x(3)))/(x(1)*x(2) + x(2)*x(3) &
             & + 2.0**(1.0/2.0)*x(1)*x(3))**2 &
             & - (2.0*(x(2) + 2.0**(1.0/2.0)*x(3))*(x(1) &
             & + x(3))*(pu*x(3) + pv*x(3) &
             & + 2.0**(1.0/2.0)*pu*x(2)))/(x(1)*x(2) &
        ...
        d2f(1,1)=((2.0*(x(2) + 2.0**(1.0/2.0)*x(3))*(pu - pv))/(x(1)*x(2) &
             & + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2 + (2.0*(x(2) &
             & + 2.0**(1.0/2.0)*x(3))**2.0*(pv*(x(1) + x(3)) - pu*(x(1) &
             & - x(3))))/(x(1)*x(2) + x(2)*x(3) &
             & + 2.0**(1.0/2.0)*x(1)*x(3))**3)/tensile_sigma2_max

        d2f(2,2)=(2.0*(x(1) + x(3))**2.0*(pv*(x(1) + x(3)) - pu*(x(1) &
        &- x(3))))/(tensile_sigma2_max*(x(1)*x(2) + x(2)*x(3) +       &
        & 2.0**(1.0/2.0)*x(1)*x(3))**3)

        d2f(3,3)=-((2.0*(x(2) + 2.0**(1.0/2.0)*x(1))*(pu +           &
        &pv))/(x(1)*x(2) + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2 -&
        ...
        d2f(2,1)=((x(1) + x(3))*(pu -&
        &pv))/(tensile_sigma2_max*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2) - (pv*(x(1) + x(3)) - pu*(x(1) -&
        &x(3)))/(tensile_sigma2_max*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2) + (2.0*(x(2) +&
        &2.0**(1.0/2.0)*x(3))*(x(1) + x(3))*(pv*(x(1) + x(3)) -&
        &pu*(x(1) - x(3))))/(tensile_sigma2_max*(x(1)*x(2) + x(2)*x(3)&
        &+ 2.0**(1.0/2.0)*x(1)*x(3))**3)

        d2f(3,2)=-((pv*(x(1) + x(3)) - pu*(x(1) - x(3)))/(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2 + ((pu + pv)*(x(1) +&
        &x(3)))/(x(1)*x(2) + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2 -&
        &(2.0*(x(2) + 2.0**(1.0/2.0)*x(1))*(x(1) + x(3))*(pv*(x(1) +&
        ...
        &x(3)) - pu*(x(1) - x(3))))/(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2 + (2.0*(x(2) +&
        &2.0**(1.0/2.0)*x(1))*(x(2) + 2.0**(1.0/2.0)*x(3))*(pv*(x(1) +&
        &x(3)) - pu*(x(1) - x(3))))/(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**3)/tensile_sigma2_max
        ...
        &2.0**(1.0/2.0)*x(1)*x(3))**3 - (2.0*2.0**(1.0/2.0)*pu*(x(1) +&
        &x(3)))/(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2)/tensile_sigma3_max
        
        d2f(3,3)=-(2.0*(x(2) + 2.0**(1.0/2.0)*x(1))**2.0*(pu*x(1) -&
        &pv*x(1) +&
        &2.0**(1.0/2.0)*pu*x(2)))/(tensile_sigma3_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**3)
                
        d2f(2,1)=((pu*x(1) - pv*x(1) +&
        &2.0**(1.0/2.0)*pu*x(2))/(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2 + ((x(1) + x(3))*(pu -&
        &pv))/(x(1)*x(2) + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2 +&
        &(2.0**(1.0/2.0)*pu*(x(2) + 2.0**(1.0/2.0)*x(3)))/(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2 - (2.0*(x(2) +&
        &2.0**(1.0/2.0)*x(3))*(x(1) + x(3))*(pu*x(1) - pv*x(1) +&
        &2.0**(1.0/2.0)*pu*x(2)))/(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**3)/tensile_sigma3_max
        
        d2f(3,2)=(pu*x(1) - pv*x(1) +&
        &2.0**(1.0/2.0)*pu*x(2))/(tensile_sigma3_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2) +&
        &(2.0**(1.0/2.0)*pu*(x(2) +&
        &2.0**(1.0/2.0)*x(1)))/(tensile_sigma3_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2) - (2.0*(x(2) +&
        &2.0**(1.0/2.0)*x(1))*(x(1) + x(3))*(pu*x(1) - pv*x(1) +&
        &2.0**(1.0/2.0)*pu*x(2)))/(tensile_sigma3_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**3)
        
        
        d2f(3,1)=(2.0**(1.0/2.0)*(pu*x(1) - pv*x(1) +&
        &2.0**(1.0/2.0)*pu*x(2)))/(tensile_sigma3_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2) + ((x(2) +&
        &2.0**(1.0/2.0)*x(1))*(pu - pv))/(tensile_sigma3_max*(x(1)*x(2)&
        &+ x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2) - (2.0*(x(2) +&
        &2.0**(1.0/2.0)*x(1))*(x(2) + 2.0**(1.0/2.0)*x(3))*(pu*x(1) -&
        &pv*x(1) + &
        &2.0**(1.0/2.0)*pu*x(2)))/(tensile_sigma3_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**3)
        ...
        !lower triangle 
        d2f(1,1)=(2.0*(x(2) +&
        &2.0**(1.0/2.0)*x(3))**2.0*(pu*x(3) + pv*x(3) +&
        ...
        &2.0**(1.0/2.0)*pu*x(2)))/(comp_sigma1_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**3) -&
        &(2.0*2.0**(1.0/2.0)*pu*(x(1) +&
        &x(3)))/(comp_sigma1_max*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2)

        d2f(3,3)=(2.0*(x(2) + 2.0**(1.0/2.0)*x(1))**2.0*(pu*x(3) +&
        &pv*x(3) + 2.0**(1.0/2.0)*pu*x(2)))/(comp_sigma1_max*(x(1)*x(2)&
        &+ x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**3) - (2.0*(x(2) +&
        &2.0**(1.0/2.0)*x(1))*(pu + pv))/(comp_sigma1_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)


        d2f(2,1)=(2.0*(x(2) + 2.0**(1.0/2.0)*x(3))*(x(1) +&
        &x(3))*(pu*x(3) + pv*x(3) +&
        &2.0**(1.0/2.0)*pu*x(2)))/(comp_sigma1_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**3) -&
        &(2.0**(1.0/2.0)*pu*(x(2) +&
        &2.0**(1.0/2.0)*x(3)))/(comp_sigma1_max*(x(1)*x(2) + x(2)*x(3)&
        &+ 2.0**(1.0/2.0)*x(1)*x(3))**2) - (pu*x(3) + pv*x(3) +&
        &2.0**(1.0/2.0)*pu*x(2))/(comp_sigma1_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)
        ...
        &x(3))*(pu*x(3) + pv*x(3) +&
        &2.0**(1.0/2.0)*pu*x(2)))/(comp_sigma1_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**3) - ((pu + pv)*(x(1) +&
        &x(3)))/(comp_sigma1_max*(x(1)*x(2) + x(2)*x(3) &
        &+2.0**(1.0/2.0)*x(1)*x(3))**2) - (2.0**(1.0/2.0)*pu*(x(2) +&
        &2.0**(1.0/2.0)*x(1)))/(comp_sigma1_max*(x(1)*x(2) + x(2)*x(3) &
        &+ 2.0**(1.0/2.0)*x(1)*x(3))**2) - (pu*x(3) + pv*x(3) +&
        &2.0**(1.0/2.0)*pu*x(2))/(comp_sigma1_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)
        
        d2f(3,1)=(2.0*(x(2) + 2.0**(1.0/2.0)*x(1))*(x(2) +&
        &2.0**(1.0/2.0)*x(3))*(pu*x(3) + pv*x(3) +&
        &2.0**(1.0/2.0)*pu*x(2)))/(comp_sigma1_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**3) - ((x(2) +&
        &2.0**(1.0/2.0)*x(3))*(pu + pv))/(comp_sigma1_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2) -&
        &(2.0**(1.0/2.0)*(pu*x(3) + pv*x(3) +&
        &2.0**(1.0/2.0)*pu*x(2)))/(comp_sigma1_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)
        ...
        d2f(1,1)=- (2.0*(x(2) +&
        &2.0**(1.0/2.0)*x(3))**2.0*(pv*(x(1) + x(3)) - pu*(x(1) -&
        &x(3))))/(comp_sigma2_max*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**3) - (2.0*(x(2) +&
        &2.0**(1.0/2.0)*x(3))*(pu - pv))/(comp_sigma2_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)
        ...
        d2f(3,3)=(2.0*(x(2) + 2.0**(1.0/2.0)*x(1))*(pu +&
        &pv))/(comp_sigma2_max*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2) - (2.0*(x(2) +&
        &2.0**(1.0/2.0)*x(1))**2.0*(pv*(x(1) + x(3)) - pu*(x(1) -&
        &x(3))))/(comp_sigma2_max*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**3)
        
        
        d2f(2,1)=(pv*(x(1) + x(3)) - pu*(x(1) -&
        &x(3)))/(comp_sigma2_max*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2) - ((x(1) + x(3))*(pu -&
        &pv))/(comp_sigma2_max*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2) - (2.0*(x(2) +&
        ...
        d2f(3,2)=(pv*(x(1) + x(3)) - pu*(x(1) -&
        &x(3)))/(comp_sigma2_max*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2) + ((pu + pv)*(x(1) +&
        &x(3)))/(comp_sigma2_max*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2) - (2.0*(x(2) +&
        &2.0**(1.0/2.0)*x(1))*(x(1) + x(3))*(pv*(x(1) + x(3)) -&
        &pu*(x(1) - x(3))))/(comp_sigma2_max*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**3)
        
        
        d2f(3,1)=((x(2) + 2.0**(1.0/2.0)*x(3))*(pu +&
        &pv))/(comp_sigma2_max*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2) + (2.0**(1.0/2.0)*(pv*(x(1) +&
        &x(3)) - pu*(x(1) - x(3))))/(comp_sigma2_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2) - ((x(2) +&
        &2.0**(1.0/2.0)*x(1))*(pu - pv))/(comp_sigma2_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2) - (2.0*(x(2) +&
        &2.0**(1.0/2.0)*x(1))*(x(2) + 2.0**(1.0/2.0)*x(3))*(pv*(x(1) +&
        &x(3)) - pu*(x(1) - x(3))))/(comp_sigma2_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**3)
        ...
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**3) - (2.0*(x(2) +&
        &2.0**(1.0/2.0)*x(3))*(pu - pv))/(comp_sigma3_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)
        ...
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**3) -&
        &(2.0*2.0**(1.0/2.0)*pu*(x(1) +&
        &x(3)))/(comp_sigma3_max*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2)
        
        d2f(3,3)=(2.0*(x(2) + 2.0**(1.0/2.0)*x(1))**2.0*(pu*x(1) -&
        &pv*x(1) + 2.0**(1.0/2.0)*pu*x(2)))/(comp_sigma3_max*(x(1)*x(2)&
        &+ x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**3)
        ...
        &x(3))*(pu*x(1) - pv*x(1) +&
        &2.0**(1.0/2.0)*pu*x(2)))/(comp_sigma3_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**3) - ((x(1) + x(3))*(pu&
        &- pv))/(comp_sigma3_max*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2) - (2.0**(1.0/2.0)*pu*(x(2) +&
        &2.0**(1.0/2.0)*x(3)))/(comp_sigma3_max*(x(1)*x(2) + x(2)*x(3)&
        &+ 2.0**(1.0/2.0)*x(1)*x(3))**2) - (pu*x(1) - pv*x(1) +&
        &2.0**(1.0/2.0)*pu*x(2))/(comp_sigma3_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)
        ...
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**3) -&
        &(2.0**(1.0/2.0)*pu*(x(2) +&
        &2.0**(1.0/2.0)*x(1)))/(comp_sigma3_max*(x(1)*x(2) + x(2)*x(3)&
        &+ 2.0**(1.0/2.0)*x(1)*x(3))**2) - (pu*x(1) - pv*x(1) +&
        &2.0**(1.0/2.0)*pu*x(2))/(comp_sigma3_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)
        ...
        d2f(3,1)=(2.0*(x(2) + 2.0**(1.0/2.0)*x(1))*(x(2) +&
        &2.0**(1.0/2.0)*x(3))*(pu*x(1) - pv*x(1) +&
        &2.0**(1.0/2.0)*pu*x(2)))/(comp_sigma3_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**3) - ((x(2) +&
        &2.0**(1.0/2.0)*x(1))*(pu - pv))/(comp_sigma3_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2) -&
        &(2.0**(1.0/2.0)*(pu*x(1) - pv*x(1) +&
        &2.0**(1.0/2.0)*pu*x(2)))/(comp_sigma3_max*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)
        !copy to upper triangle
        ...
        !lower triangle 
        d2f(1,1)=((2.0*L*(x(2) +&
        &2.0**(1.0/2.0)*x(3))*(pu - pv))/(E*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2) - (2.0*L*(x(2) +&
        &2.0**(1.0/2.0)*x(3))**2.0*(pu*x(1) + pu*x(3) - pv*x(1) +&
        &pv*x(3) + 2.0*2.0**(1.0/2.0)*pu*x(2)))/(E*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**3))/max_u_disp
        
        d2f(2,2)=-((2.0*L*(x(1) + x(3))**2.0*(pu*x(1) + pu*x(3) -&
        &pv*x(1) + pv*x(3) + 2.0*2.0**(1.0/2.0)*pu*x(2)))/(E*(x(1)*x(2)&
        &+ x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**3) -&
        &(4*2.0**(1.0/2.0)*L*pu*(x(1) + x(3)))/(E*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2))/max_u_disp
        
        d2f(3,3)=((2.0*L*(x(2) + 2.0**(1.0/2.0)*x(1))*(pu +&
        &pv))/(E*(x(1)*x(2) + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)&
        &- (2.0*L*(x(2) + 2.0**(1.0/2.0)*x(1))**2.0*(pu*x(1) + pu*x(3)&
        &- pv*x(1) + pv*x(3) +&
        &2.0*2.0**(1.0/2.0)*pu*x(2)))/(E*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**3))/max_u_disp
        
        
        d2f(2,1)=((L*(pu*x(1) + pu*x(3) - pv*x(1) + pv*x(3) +&
        &2.0*2.0**(1.0/2.0)*pu*x(2)))/(E*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2) + (L*(x(1) + x(3))*(pu -&
        &pv))/(E*(x(1)*x(2) + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)&
        &+ (2.0*2.0**(1.0/2.0)*L*pu*(x(2) +&
        &2.0**(1.0/2.0)*x(3)))/(E*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2) - (2.0*L*(x(2) +&
        &2.0**(1.0/2.0)*x(3))*(x(1) + x(3))*(pu*x(1) + pu*x(3) -&
        &pv*x(1) + pv*x(3) + 2.0*2.0**(1.0/2.0)*pu*x(2)))/(E*(x(1)*x(2)&
        &+ x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**3))/max_u_disp
        
        d2f(3,2)=((L*(pu*x(1) + pu*x(3) - pv*x(1) + pv*x(3) +&
        &2.0*2.0**(1.0/2.0)*pu*x(2)))/(E*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2) + (L*(pu + pv)*(x(1) +&
        &x(3)))/(E*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2) + (2.0*2.0**(1.0/2.0)*L*pu*(x(2)&
        &+ 2.0**(1.0/2.0)*x(1)))/(E*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2) - (2.0*L*(x(2) +&
        &2.0**(1.0/2.0)*x(1))*(x(1) + x(3))*(pu*x(1) + pu*x(3) -&
        &pv*x(1) + pv*x(3) + 2.0*2.0**(1.0/2.0)*pu*x(2)))/(E*(x(1)*x(2)&
        &+ x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**3))/max_u_disp
        
        
        d2f(3,1)=((L*(x(2) + 2.0**(1.0/2.0)*x(1))*(pu -&
        &pv))/(E*(x(1)*x(2) + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)&
        &+ (L*(x(2) + 2.0**(1.0/2.0)*x(3))*(pu + pv))/(E*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2) +&
        &(2.0**(1.0/2.0)*L*(pu*x(1) + pu*x(3) - pv*x(1) + pv*x(3) +&
        &2.0*2.0**(1.0/2.0)*pu*x(2)))/(E*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2) - (2.0*L*(x(2) +&
        &2.0**(1.0/2.0)*x(1))*(x(2) + 2.0**(1.0/2.0)*x(3))*(pu*x(1) +&
        &pu*x(3) - pv*x(1) + pv*x(3) +&
        &2.0*2.0**(1.0/2.0)*pu*x(2)))/(E*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**3))/max_u_disp
        ...
        &2.0**(1.0/2.0)*x(3))*(pu - pv))/(E*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2) + (2.0*L*(x(2) +&
        &2.0**(1.0/2.0)*x(3))**2.0*(pu*x(3) - pu*x(1) + pv*x(1) +&
        &pv*x(3)))/(E*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**3))/max_v_disp
        
        d2f(2,2)=(2.0*L*(x(1) + x(3))**2.0*(pu*x(3) - pu*x(1) +&
        &pv*x(1) + pv*x(3)))/(E*max_v_disp*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**3)
        
        d2f(3,3)=((2.0*L*(x(2) + 2.0**(1.0/2.0)*x(1))**2.0*(pu*x(3) -&
        &pu*x(1) + pv*x(1) + pv*x(3)))/(E*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**3) - (2.0*L*(x(2) +&
        &2.0**(1.0/2.0)*x(1))*(pu + pv))/(E*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2))/max_v_disp
        
        
        d2f(2,1)=(L*(x(1) + x(3))*(pu - pv))/(E*max_v_disp*(x(1)*x(2)&
        &+ x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2) - (L*(pu*x(3) -&
        &pu*x(1) + pv*x(1) + pv*x(3)))/(E*max_v_disp*(x(1)*x(2) +&
        &x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2) + (2.0*L*(x(2) +&
        &2.0**(1.0/2.0)*x(3))*(x(1) + x(3))*(pu*x(3) - pu*x(1) +&
        &pv*x(1) + pv*x(3)))/(E*max_v_disp*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**3)
        
        d2f(3,2)=-((L*(pu*x(3) - pu*x(1) + pv*x(1) +&
        &pv*x(3)))/(E*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2) + (L*(pu + pv)*(x(1) +&
        &x(3)))/(E*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2) - (2.0*L*(x(2) +&
        ...
        d2f(3,1)=((L*(x(2) + 2.0**(1.0/2.0)*x(1))*(pu -&
        &pv))/(E*(x(1)*x(2) + x(2)*x(3) + 2.0**(1.0/2.0)*x(1)*x(3))**2)&
        &- (2.0**(1.0/2.0)*L*(pu*x(3) - pu*x(1) + pv*x(1) +&
        &pv*x(3)))/(E*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2) - (L*(x(2) +&
        &2.0**(1.0/2.0)*x(3))*(pu + pv))/(E*(x(1)*x(2) + x(2)*x(3) +&
        &2.0**(1.0/2.0)*x(1)*x(3))**2) + (2.0*L*(x(2) +&
        &2.0**(1.0/2.0)*x(1))*(x(2) + 2.0**(1.0/2.0)*x(3))*(pu*x(3) -&
        &pu*x(1) + pv*x(1) + pv*x(3)))/(E*(x(1)*x(2) + x(2)*x(3) +&
