...
SRCS = dimpce.o main.o evalcostf.o higher.o LUroutines.o collsub.o srsmsub.o ludcmp.o lubksb.o svdcmp.o svbksb.o pythag.o randomroutines.o exactoutputfile.o sampdist.o dynsampdist.o setuprhs.o setupmat.o tecplot.o montecarlo.o mypoly.o mpi.o nieder.o sobol.o faure.o hammersley.o halton.o
