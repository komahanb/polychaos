...
SRCS = dimpce.o main.o higher.o LUroutines.o collsub.o srsmsub.o ludcmp.o lubksb.o svdcmp.o svbksb.o pythag.o randomroutines.o exactoutputfile.o sampdist.o dynsampdist.o evalcostf.o threebarcost.o setuprhs.o setupmat.o tecplot.o montecarlo.o mypoly.o mpi.o optimize.o BFGSroutines.o CalcstuffBFGS.o nieder.o sobol.o faure.o hammersley.o halton.o rmsebound.o rbf.o
